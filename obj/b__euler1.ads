...
package ada_main is
   ...
   Ada_Main_Program_Name : constant String := "_ada_euler1" & ASCII.NUL;
   ...
   u00001 : constant Version_32 := 16#eba37c55#;
   pragma Export (C, u00001, "euler1B");
   ...
   u00126 : constant Version_32 := 16#4aa988d0#;
   pragma Export (C, u00126, "system__concat_2B");
   u00127 : constant Version_32 := 16#6e69c395#;
   pragma Export (C, u00127, "system__concat_2S");
   u00128 : constant Version_32 := 16#1982dcd0#;
   pragma Export (C, u00128, "system__memoryB");
   u00129 : constant Version_32 := 16#08abf447#;
